...
logTable = Text(resultWindow, width=500, height=400)
logTable.pack()
...
def openFile():
    global fileEntry, mainFrame, regressionSet, classifierSet, filename
...
def start_proc():
    global filename, regressionSet, classifierSet, lineNum
